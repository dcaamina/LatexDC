...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{A_Placa_2.png}
	\captionof{figure}{Esquema del microcontrolador}
\end{figure}
\begin{figure}[H]
	\centering	\includegraphics[scale=0.8]{A_Placa_1.png}
	\captionof{figure}{Esquema de la placa adaptadora}
\end{figure}
\begin{figure}[H]
	\centering
	\subfigure[]{\includegraphics[scale=0.8]{A_Placa_3.png}}
	\subfigure[]{\includegraphics[scale=0.8]{A_Placa_31.png}}
	\caption{Esquema de entradas/ salidas} 
\end{figure}
\begin{figure}[H]
	\centering	\includegraphics[scale=0.8]{A_Placa_4.png}
\end{figure}	
	\captionof{figure}{Esquema de la placa reguladora}
\begin{figure}[H]
	\centering	\includegraphics[scale=0.8]{A_Placa_5.png}
