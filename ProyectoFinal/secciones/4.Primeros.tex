...
\subsubsection{Cálculo de número de Reynolds}
	El número de Reynolds fue calculado a partir de la ECUACIONNNN, que relaciona las fuerzas inerciales y las fuerzas viscosas. La viscosidad dinámica del fluido es un valor obtenido de la tabla \hl{ver pagina google}  mientras que el valor de densidad fue calculado con los valores de temperatura, humedad y presión de un día dado.
\begin{equation}	
	R_e=\frac{\rho\;D\;v}\mu
\end{equation}	
dónde:\\
