...
\input{secciones/len_arduino}%biblioteca de codigos
\input{secciones/len_processing}
\usepackage{appendix}
...
\fancyhead[L]{}
\fancyhead[R]{}
\fancyhead[C]{\textbf{Automatización del Túnel de Viento}}
\fancyfoot[L]{}
\fancyfoot[C]{\thepage}
...
\newpage
	\section{Fluido: Aire}
	\subsection{Ecuación para el cálculo de la velocidad del aire} \label{sec:ecvel}
