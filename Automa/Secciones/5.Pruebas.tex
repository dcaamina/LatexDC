...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{somove1.png}
	\captionof{figure}{Elección de Altivar 312}
	\label{fig:so1}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{somove2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{images/paramsomove}
...
\begin{center}
	...
	\label{fig:uni1}
	\includegraphics[width=0.7\linewidth]{unity1.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{2.ethern.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{3.previo.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{4.read.png}
