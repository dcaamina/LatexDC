...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{pc_var.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.5\linewidth]{vcan.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{CAN01.png}
	\captionof{figure}{Configuración variador CANopen}
	\label{fig:CAN01}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\subfigure[]{\includegraphics[scale=0.8]{parama.png}}
	\subfigure[]{\includegraphics[scale=1]{param.png}}
...
\begin{figure}[h!]
	\centering
	\subfigure[]{\includegraphics[scale=0.5]{escalado01.png}}
	\subfigure[]{\includegraphics[scale=0.5]{escalado02.png}}
