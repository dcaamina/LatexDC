...
\begin{figure}[htb]
	...
	\captionof{figure}{Comparación de la planta estimada y los valores obtenidos para FT001}
	\label{fig:ft001}
\end{figure}
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.9\linewidth]{Strenj_RESPUESTA1.png}
	\captionof{figure}{Comparación de la planta estimada y los valores obtenidos para PIT001}
	\label{fig:PIT001}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.9\linewidth]{Strenj_respuesta2.png}
	\captionof{figure}{Comparación de la planta estimada y los valores obtenidos para PIT002}
	\label{fig:PIT002}
\end{figure}
...
Los valores obtenidos de la aplicación perteneciente a Matlab se muestran en la tabla \ref{tab:pid}, los cuales se ingresaron en los bloques de \textit{UnityPro} con las respectivas modificaciones numéricas según lo establecido por el software. Los valores mostrados en dicha tabla serán usados al momento de restablecer los PID del sistema en la pantalla SCADA (CITAR LA SECCION DONDE SE EXPLICA ESE BOTON).
\begin{comment}
...
\begin{figure}[htbp]
	\centering
	\subfigure[FT1B]{\includegraphics[width=80mm]{FT1b.png}}
\hspace{-4mm}
	\subfigure[FT1c]{\includegraphics[width=80mm]{FT1c.png}}
	\caption{ft} \label{fig:FT1}
\end{figure}

\begin{figure}[htbp]
	\centering
	\subfigure[PIT1a]{\includegraphics[width=80mm]{PIT1b.png}}
\hspace{-4mm}
	\subfigure[pit1c]{\includegraphics[width=80mm]{PIT1c.png}}
	\caption{pit1} \label{fig:PIT1}
\end{figure}

\begin{figure}[htbp]
	\centering
	\subfigure[PIT2a]{\includegraphics[width=80mm]{PIT2a.png}}
	\hspace{-4mm}
	\subfigure[pit2b]{\includegraphics[width=80mm]{PIT2b.png}}
