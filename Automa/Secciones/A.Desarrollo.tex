...
Para la prueba de control con FT01 (Figura \ref{fig:per1}) como variable de proceso, a los 20 segundos se fijó el valor de referencia en 3,5 L/min. Luego, se abrió la válvula FV01 completamente y se observó la disminución del caudal, la acción de control elevó las revoluciones del motor hasta que la variable de salida alcanza la referencia. A los 90 segundos se modifica la referencia y se observa su buen comportamiento durante la disminución del caudal. Aproximadamente a los 125 segundos se configuró el valor de referencia en 2 L/min y luego se cerró la válvula FV01, esto provocó que todo el caudal circule por FT01 y la acción de control disminuyó las revoluciones del motor hasta llegar al valor de caudal de referencia.
