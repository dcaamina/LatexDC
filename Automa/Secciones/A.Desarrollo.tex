...
\begin{itemize}
	...
	\item T= Retardo
\end{itemize}
Para obtener la función de transferencia se realizó un script en \textbf{Matlab} que dió como resultado los siguientes sistemas:
\begin{itemize}
