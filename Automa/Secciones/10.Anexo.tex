...
\newpage
\section{Anexo: Tabla de Direcciones} \label{Anexo1}
...
\newpage
\section{Anexo: Causa efecto de alarmas}  \label{Anexo2}
	...
	\begin{table}[h!]
		...
		\resizebox{21cm}{!} {
			...
			\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|} 
				...
				\hline
				\textbf{TT001}                                                                                                    & Temperatura                                             & °C                                                      &                                                                 &                                                                 &                                                                   &                                                                & 50                                                             &                                                                   &                                                                   &                                                                   &                                                                &                                                                &                                                                   &                                                                 & \begin{tabular}[c]{@{}l@{}}Informar alta temperatura \\del motor\end{tabular}                                         &                                                                                                                                \\ 
				\hline
				\textbf{TT001}                                                                                                    & Temperatura                                             & °C                                                      &                                                                 &                                                                 & 70                                                                &                                                                &                                                                &                                                                   &                                                                   & 70                                                                &                                                                &                                                                &                                                                   & P                                                               & \begin{tabular}[c]{@{}l@{}}Informar muy alta temperatura \\del motor\end{tabular}                                     & Daño al bobinado                                                                                                               \\ 
				\hline
...
\begin{figure}[htbp]
	\centering
	\subfigure[Pantalla datos históricos]{\includegraphics[width=1\linewidth]{scada3.png}}
	\subfigure[Guardar datos históricos]{\includegraphics[width=1\linewidth]{scada33.png}}
