...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.3]{esquema01.png}
	\captionof{figure}{Esquemático de conexión}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{tarjetagit.png}
	\captionof{figure}{Tarjeta Github}
